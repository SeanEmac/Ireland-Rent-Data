...
for i in range(len(cities)):
    cityData.append(df.loc[(df['Property Type'] == 'All property types') 
    & (df['Number of Bedrooms'] == 'All bedrooms') & (df['Location'] == cities[i])])
    plt.plot(cityData[i]['Quarter'], cityData[i]['num'])


plt.legend(['Dublin', 'Galway', 'Cork', 'Limerick', 'Athlone', 'Waterford'],
